...
public class TrysKvadratai2 implements VisionProcessor {

    int y = 70;
    int x = 110;
    int xx = 200;
    public Rect rectLeft = new Rect(x, y, 40, 200);
 public Rect rectMiddle = new Rect(xx + x , y, 40, 200);
 public Rect rectRight = new Rect(xx * 2 + x, y, 40, 200);
