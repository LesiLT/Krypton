...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1676.377814624509; // y position of the first parallel encoder (in tick units)
        public double par1YTicks =  -1810.0327017753816; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1218.8220073405635; // x position of the perpendicular encoder (in tick units)
    }
