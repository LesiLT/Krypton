...
/// O = odometrija
@Autonomous (name = "Auto+2BSpeed")
public class Auto2MSpeed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(drive.actionBuilder(new Pose2d(0, 0, 0))
                .lineToXLinearHeading(-10, -Math.PI/18)
                .stopAndAdd(new šauti(sm1, sm2, pad, pem, 0.96))
                .lineToXLinearHeading(-33, Math.PI/4.5)
                .build());
        /// Strafe
        Actions.runBlocking(drive.actionBuilder(new Pose2d(0, 0, 0))
        ...
        pad.setPower(0.0);
        Actions.runBlocking(drive.actionBuilder(new Pose2d(0, 0, 0))
                        .lineToXLinearHeading(20, -Math.PI/6)
                /// Patestuoti ar veikia <->
//                .lineToX(20)
//                .turn(-Math.PI/6)
                .build()
        );
